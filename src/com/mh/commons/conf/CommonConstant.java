...
public final class CommonConstant{
	...
	static{
		...
		visitList.add("/antiHack_pc");
		visitList.add("/antiHack_android");
		visitList.add("/antiHack_ios");
		visitList.add("/login");
		visitList.add("/promologin");
		visitList.add("/loginRule");
		visitList.add("/yzc_electronic");
		visitList.add("/eleFavourite");
		visitList.add("/mobileelectronic");
		
		visitList.add("/excel/read");
		visitList.add("/allHoteleGame");
		...
		visitList.add("/m/getPromosList");
		visitList.add("/m/getEleGameList");
		visitList.add("/m/getGongGaoList");
		visitList.add("/m/getCarouselList");
