...
public class WebClientInterfaceController {
	...
	public void slot(HttpServletRequest request, HttpServletResponse response){
		try{
			...
			WebResourceDataHelper helper = new WebResourceDataHelper();
			helper.initData();
	...
	@RequestMapping(value="/electroniccache")
	public void electroniccache(HttpServletRequest request, HttpServletResponse response){
		try{
