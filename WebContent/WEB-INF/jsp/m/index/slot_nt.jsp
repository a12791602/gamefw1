    ...
    <div class="ybb-slot-main">
      <div data-role="navbar" class="slot-hall">
        <ul>
          ...
          <li><a href="${ctx }/m/main?code=slot_nt" data-ajax="false" class="ui-btn-active">NT电子</a></li>
        </ul>
      </div>
      <div class="game-group">
        <div class="ui-grid-a">
           <c:forEach var="item" items="${ntslot }" varStatus="itemStatus">
           	...
           	<c:choose>
				<c:when test="${empty webUser}">
				  ...
				  <a href="javascript:void(0);" onclick="alert('请先登录');">
			            <div class="r1" style=" background-image: url(${resourceRoot}/web/ybb/common/images/newnt/${item.eleGamePic});"></div>
		        ...
		        <c:otherwise>
		        	<div class="ui-block-a item">
		          		<a onclick="checkFlatSatus('${ctx }/m/game/forwardGame?gameType=newnt&game=${item.eleGameCode}','newnt');" href="javascript:void(0);" data-ajax="false">
		            		<div class="r1" style=" background-image: url(${resourceRoot}/web/ybb/common/images/newnt/${item.eleGamePic});"></div>
		            		<p class="r2 ac">${item.eleGameCnname}</p>
		          		</a>
		          	</div>
