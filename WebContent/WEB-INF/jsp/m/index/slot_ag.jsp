...
<div data-role="page" data-theme="x" class="ybb-mobile-web">
  ...
  <div role="main" class="ui-content">
    ...
    <div class="ybb-slot-main">
      <div data-role="navbar" class="slot-hall" style="display: none;">
        <ul>
...
<div class="ybb-main ybb-live-main">
  ...
  <div class="r2">
    ...
    <p>游戏种类：</p>
    <p>真人：百家乐 / 免水百家乐 / 龙虎斗 / 轮盘 / 骰宝</p>
    <p>电子：捕鱼王2、XIN电子、TTG电子、NYX电子等</p>
  ...
  <div class="r3">
    <c:choose>
      ...
      <c:otherwise>
        <a href="javascript:void(0);" onclick="checkFlatSatus('${ctx}/m/game/forwardGame?agGameType=11&gameType=ag','ag');" class="ui-btn ui-btn-f" data-ajax="false">进入AG电子游艺</a>
      </c:otherwise>
    </c:choose>
  </div>
</div>
