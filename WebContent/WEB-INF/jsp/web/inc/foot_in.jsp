...
<style>
	div>div>a[title="点击关闭"]{
		display: inline-block;
    width: 30px;
    border: 1px solid #f2dd81;
    height: 15px;
    line-height: 15px;
    color: #ffff8a;
    background: #956811;
...
<div style="position: fixed;right: 0;bottom: 5px;">
	<div>
	  <a href="${ctx}/antiHack_pc" target="_blank">
	    <img src="${resourceRoot}/web/ybb/assets/img/antiHack/anti.png" width="80px">
	  </a>
	</div>
	<div style="text-align: center;" onclick="this.parentNode.style.display='none';">
	  <a href="javascript:void(0);" title="点击关闭">
	  	关闭
	    <!-- <img src="${resourceRoot}/web/ybb/assets/img/antiHack/close.png" width="15px"> -->
	  </a>
	</div>
</div>