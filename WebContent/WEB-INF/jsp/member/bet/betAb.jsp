								...
								<table class="center">
									...
									<c:forEach var="item" items="${page.result}" varStatus="item_index">
										<tr class="sheet-body s12">
											...
											<td align="center" title="${item.bet_game_result}">${item.bet_game_result}</td>
											<td align="center" title="${item.bet_content}">${item.bet_content}</td>
											<td align="center">
												${item.bet_in}
											</td>
											<td align="center">
												${item.bet_usr_win*(-1)<0?"<font color=red>":"<font color=green>"}
												${item.bet_usr_win}
											</td>
										</tr>
									</c:forEach>
