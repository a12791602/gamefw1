...
<div class="page-title clear">
	<div class="left">
		...
		<p class="mt5 gray">尊敬的客户您好，使用微信扫一扫二维码进行转账</p>
	</div>
...
<div class="page-body switch-mod">
	<div class="switch-group">
		<div class="switch-item" align="center" style="padding-top: 10px;">
			<p style="font-size: 16px;">请认真核实收款方昵称/微信号！</p></br>
			<p><span style="font-size: 14px; color: red;">昵称:${webKjPay.payNname}</span></p></br>
			<p><span style="font-size: 14px; color: red;">微信号:${webKjPay.payRname}</span></p></br>
					...
					<div class="sheet-mod">
						<div class="sheet-content mt10">
							...
							<table class="mt20 s14">
								...
								<tr>
									<td class="pr20 ar gray-dark"><label for="rechargeName">您微信昵称</label></td>
									<td class="s12" align="left"  > 
