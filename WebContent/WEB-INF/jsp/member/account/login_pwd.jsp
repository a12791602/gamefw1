					...
					<div class="page-body">
						<div class="panel-progress">
							<ul class="progress-step-group clear">
								<li class="step step-one step-active"><div class="step-inner"><span class="step-icon">1</span><h2>输入新密码</h2></div></li>
									...
									<div class="sheet-content pt20">
										<table class="mt20 s14">
											<tr>
												...
												<td class="s12">
													<input  type="password" name="oldPwd" id="oldPwd" maxlength="12" class="write b red"  />
												</td>
											</tr>
											<tr>
												<td class="pr20 ar gray-dark">新密码</td>
												<td class="s12"> 
													<input type="password"  name="newPwd" id="newPwd" maxlength="12" class="write b red"  />
											...
											<tr>
												...
												<td class="s12">
													<input type="password"  name="renewPwd" id="renewPwd" maxlength="12"  class="write b red" />
												</td>
											</tr>
											<tr>
												<td></td>
												<td>
													<button class="button button-raised button-primary button-small" onclick="checkEditPwdForm();return false;">确认</button>
												</td>
											</tr>
										</table>
									</div>
