...
<%@ page language="java" import="java.util.*,com.mh.commons.constants.*,org.apache.commons.lang.StringUtils"%>
...
<script src="${resourceRoot}/member/js/custom-plugin.js"></script>
...
<%
 Object themeObject = WebSiteManagerConstants.SYSPARAMMAP.get("pc_member_theme");
 String theme = "theme-red";
 if(themeObject!=null){
     theme = StringUtils.defaultIfEmpty((String)themeObject, "theme-red");
 }
 request.getSession().setAttribute("theme", "theme-red");
%>
