    ...
    <div class="ybb-slot-main">
      <div data-role="navbar" class="slot-hall">
        <ul>
          ...
          <li><a href="${ctx }/m/main?code=slot_mg" data-ajax="false" class="ui-btn-active">MG电子</a></li>
           	...
           	<c:choose>
				<c:when test="${empty webUser}">
				  ...
				  <a href="javascript:void(0);" onclick="alert('请先登录');">
			            <div class="r1" style=" background-image: url(${resourceRoot}/web/ybb/common/images/mg/${item.eleGamePic}_h5.png);"></div>
		        ...
		        <c:otherwise>
		        	<div class="ui-block-a item">
		        		<%--<a onclick="checkFlatSatus('${ctx }/m/mg/goMg?gameType=mgElectronic&gameName=${item.eleGameId}','mg');" href="javascript:void(0);" data-ajax="false">
		            		<div class="r1" style=" background-image: url(${resourceRoot}/web/ybb/common/images/mg/${item.eleGamePic}_h5.png);"></div>
		            		<p class="r2 ac">${item.eleGameCnname}</p>
		          		</a>--%>
		          		<a onclick="checkFlatSatus('${ctx }/m/game/forwardGame?gameName=${item.eleGameId}&gameType=mg&gameCode=${item.remark}','mg');" href="javascript:void(0);" data-ajax="false">
		            		<div class="r1" style=" background-image: url(${resourceRoot}/web/ybb/common/images/mg/${item.eleGamePic}_h5.png);"></div>
		            		<p class="r2 ac">${item.eleGameCnname}</p>
		          		</a>
		          	</div>
