...
<%
	...
	request.getSession().setAttribute("dev", false);
    request.getSession().setAttribute("v", "1713");
%>
<!doctype html>
...
<head>
	...
	<c:if test="${dev eq false }">
		<script type="text/javascript" src="${resourceRoot }/wap/member/app/dist/main-min.js?v=${v}"></script>
    <script type="text/javascript" src="${resourceRoot }/wap/member/app/dist/templates.js?v=${v}"></script>
		<script type="text/javascript" src="${resourceRoot }/wap/member/app/dist/app.module-min.js?v=${v}"></script>
	</c:if>
