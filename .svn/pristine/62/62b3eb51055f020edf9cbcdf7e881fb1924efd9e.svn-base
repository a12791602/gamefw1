...
import com.mh.commons.excel.ExcelExportUtils;
...
public class ServletUtils {
	 ...
	 * @throws IOException
	 */
	public static void flushExcelOutputStream(HttpServletRequest request, HttpServletResponse response, List<?> dataList){
		response.setHeader("Content-Disposition", "attachment; filename="+ System.currentTimeMillis() + ".xls");  
		HSSFWorkbook workbook = new ExcelExportUtils().exportExcel(System.currentTimeMillis() + "", dataList);
