  	...
  	<form id="regForm" name="regForm" method="POST" action="">
	    <div class="account-form f12">
	      <div data-role="fieldcontain">
	        ...
	        <input type="text" onkeyup="charSize(this,10);" onblur="validRegisterUserName(this);" name="userName" id="userName" placeholder="请输入4-10个字符,仅可输入英文字母以及数字的组合!">
	      </div>
	      <div data-role="fieldcontain">
	      ...
	      <div data-role="fieldcontain">
	        <label for="userAgent"><font style="color: red;">*</font>介绍人：</label>
	        <input type="text" name="userAgent" id="userAgent" placeholder="默认(888)" value="${(empty agentNo)?'888':agentNo}" onblur="validUserAgent(this)">
	      </div>
	      <div data-role="fieldcontain">
