...
public class ResourceConstant {
	...
	public static List<WebNewNtElectronic> MOBILE_NEWNT_ELECTRONIC_LIST;
	...
	public static List<TWebElectronicClass> MG_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> OS_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> PT_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> NEWNT_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> TTG_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> GD_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> AG_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static List<TWebElectronicClass> BBIN_ELECTRONIC_CLASS = new ArrayList<TWebElectronicClass>();
	public static Map<String,List<TWebElectronicClass>> ELECTRONIC_CLASS_MAP = new HashMap<String, List<TWebElectronicClass>>();
	
	public static List<WebNewNtElectronic> NEWNT_ELECTRONIC_HOT = new ArrayList<WebNewNtElectronic>();
	public static List<WebMgElectronic> MG_ELECTRONIC_HOT = new ArrayList<WebMgElectronic>();
	public static List<WebPtElectronic> PT_ELECTRONIC_HOT = new ArrayList<WebPtElectronic>();
	public static List<WebOsElectronic> OS_ELECTRONIC_HOT = new ArrayList<WebOsElectronic>();
	public static List<WebTtgElectronic> TTG_ELECTRONIC_HOT = new ArrayList<WebTtgElectronic>();
	public static List<WebGdElectronic> GD_ELECTRONIC_HOT = new ArrayList<WebGdElectronic>();
	public static List<WebAgElectronic> AG_ELECTRONIC_HOT = new ArrayList<WebAgElectronic>();
	public static List<WebBbinElectronic> BBIN_ELECTRONIC_HOT = new ArrayList<WebBbinElectronic>();
	
	public static List<WebNewNtElectronic> MOBILE_NEWNT_ELECTRONIC_HOT = new ArrayList<WebNewNtElectronic>();
	public static List<WebMgElectronic> MOBILE_MG_ELECTRONIC_HOT = new ArrayList<WebMgElectronic>();
	public static List<WebPtElectronic> MOBILE_PT_ELECTRONIC_HOT = new ArrayList<WebPtElectronic>();
	public static List<WebOsElectronic> MOBILE_OS_ELECTRONIC_HOT = new ArrayList<WebOsElectronic>();
	public static List<WebTtgElectronic> MOBILE_TTG_ELECTRONIC_HOT = new ArrayList<WebTtgElectronic>();
	
	public static List<WebNewNtElectronic> NEWNT_ELECTRONIC_NEW = new ArrayList<WebNewNtElectronic>();
	public static List<WebMgElectronic> MG_ELECTRONIC_NEW = new ArrayList<WebMgElectronic>();
	public static List<WebPtElectronic> PT_ELECTRONIC_NEW = new ArrayList<WebPtElectronic>();
	public static List<WebOsElectronic> OS_ELECTRONIC_NEW = new ArrayList<WebOsElectronic>();
	public static List<WebTtgElectronic> TTG_ELECTRONIC_NEW = new ArrayList<WebTtgElectronic>();
	public static List<WebGdElectronic> GD_ELECTRONIC_NEW = new ArrayList<WebGdElectronic>();
	public static List<WebAgElectronic> AG_ELECTRONIC_NEW = new ArrayList<WebAgElectronic>();
	public static List<WebBbinElectronic> BBIN_ELECTRONIC_NEW = new ArrayList<WebBbinElectronic>();
	
	public static List<WebNewNtElectronic> MOBILE_NEWNT_ELECTRONIC_NEW = new ArrayList<WebNewNtElectronic>();
	public static List<WebMgElectronic> MOBILE_MG_ELECTRONIC_NEW = new ArrayList<WebMgElectronic>();
	public static List<WebPtElectronic> MOBILE_PT_ELECTRONIC_NEW = new ArrayList<WebPtElectronic>();
	public static List<WebOsElectronic> MOBILE_OS_ELECTRONIC_NEW = new ArrayList<WebOsElectronic>();
	public static List<WebTtgElectronic> MOBILE_TTG_ELECTRONIC_NEW = new ArrayList<WebTtgElectronic>();
	...
	public static Map<String,List<WebAgElectronic>> AG_ELECTRONIC_LIST;
	...
	public static Map<String,List<WebBbinElectronic>> BBIN_ELECTRONIC_LIST;
	public static List<WebNtElectronic> NT_ELECTRONIC_LIST;
	
	public static List<String> OS_ELECTRONIC_H5GAME;
	
	public static Map<String, String> ntElectronic = new HashMap<String, String>();
	public static Map<String, String> PT_ELECTRONIC = new HashMap<String, String>();
	...
	public static String HOT = "hot";//热门游戏
	public static String NEW = "new";//新款游戏
	public static String FAVOURITE = "favourite";//收藏游戏
